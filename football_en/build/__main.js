$(document).ready(function() {
        ...
        if (obj.descr) {
            ...
            img.each(function() {
                switch ($(this).attr('alt')) {
                    case 'goal':
                        $(this).attr('src', 'https://js.dooh.xyz/football_en/server/images/ball.svg');
                        break;
                    case 'redcard':
                        $(this).attr('src', 'https://js.dooh.xyz/football_en/server/images/redcard.svg');
                        break;
                    case 'yellowcard':
                        $(this).attr('src', 'https://js.dooh.xyz/football_en/server/images/yellowcard.svg');
                        break;
                }
            })
        } else {
    ...
    try {
        ...
        $.ajax({
            url: 'https://js.dooh.xyz/football_en/server/redirect.php',
            beforeSend: function(){
                time = new Date();
